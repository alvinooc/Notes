...
- GEC 会被放入到ECS中执行，其中包含两部分内容：
  ...
  - **第二部分**：在代码执行中，对变量赋值或执行其他的函数
    ...
    ![image-20220415195357142](https://cdn.jsdelivr.net/gh/alvinooc/Notes@master/Images/image-20220415195357142.png)

    ![image-20220415195511682](https://cdn.jsdelivr.net/gh/alvinooc/Notes@master/Images/image-20220415195511682.png)
...
* 在执行到一个函数时，会根据函数体创建一个**函数的执行上下文（Functional Execution Context，简称FEC），**并且压入到EC Stack中。FEC中包含三部分内容：
  ...
  - 第三部分：this绑定的值
    ...
    ![image-20220415195733198](https://cdn.jsdelivr.net/gh/alvinooc/Notes@master/Images/image-20220415195733198.png)

    ![image-20220415195953303](https://cdn.jsdelivr.net/gh/alvinooc/Notes@master/Images/image-20220415195953303.png)
...
* JavaScript会在定义变量时分配内存
  ...
  - 对于**复杂数据类型的内存分配**会在堆内存中开辟一块空间，并且将这块空间的指针返回给值变量引用
    ...
    ![image-20220415200029374](https://cdn.jsdelivr.net/gh/alvinooc/Notes@master/Images/image-20220415200029374.png)
...
- 常见的GC算法
  ...
  - **引用计数**
    ...
    - 这个算法有一个很大的弊端就是会产生循环引用
      ...
      ![image-20220415200102234](https://cdn.jsdelivr.net/gh/alvinooc/Notes@master/Images/image-20220415200102234.png)
  ...
  - **标记清除（常用）**
    ...
    - 这个算法可以很好的解决循环引用的问题
      ...
      ![image-20220415200113786](https://cdn.jsdelivr.net/gh/alvinooc/Notes@master/Images/image-20220415200113786.png)
